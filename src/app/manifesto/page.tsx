    ...
    <>
      <Section className="border-b border-white/5 pt-32">
        <div className="mx-auto max-w-4xl text-center">
          <p className="eyebrow justify-center">— 宣言</p>
          <h1 className="display mt-6 text-balance text-5xl text-sail md:text-7xl">
            一所为水手、
            <br />
            也为<span className="text-gold">船长的思维</span>而设的学校。
          </h1>
          <p className="mx-auto mt-8 max-w-2xl text-base leading-[1.9] text-mist/75 md:text-lg">
      ...
      <Section>
        <div className="mx-auto max-w-3xl">
          {articles.map((a) => (
            <article
              key={a.n}
              className="grid grid-cols-[4rem_1fr] gap-6 border-t border-white/10 py-16 first:border-t-0"
            >
              <p className="display text-3xl text-gold">第 {a.n}</p>
              <div>
                <h2 className="display text-2xl text-sail md:text-3xl">
                  {a.t}
                </h2>
                <p className="mt-4 text-base leading-[1.9] text-mist/80">
                  {a.body}
                </p>
              </div>
            </article>
        ...
        <div className="mx-auto mt-24 max-w-3xl border-t border-white/10 pt-16 text-center">
          ...
          <p className="mt-4 font-mono text-[0.78rem] tracking-[0.34em] text-mist/55">
